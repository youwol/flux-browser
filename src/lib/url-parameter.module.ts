import { BuilderView, Flux, Property, Schema, ModuleFlux, freeContract, Pipe } from '@youwol/flux-core';
import { pack } from './main'


export namespace ModuleUrlParameter {
    ...
    export class PersistentData {
        ...
        readonly parameterName: string = "id"

        /**
         * If true, gets the unencoded version of an encoded parameter value of a Uniform Resource Identifier (URI)
         */
        @Property({ description: "If true, gets the unencoded version of an encoded parameter value of a Uniform Resource Identifier (URI)" })
        readonly decodeURI: boolean = false

        constructor(params: { parameterName?: string } = {}) {
    ...
    @Flux({
        pack: pack,
        namespace: ModuleUrlParameter,
        id: "ModuleUrlParameter",
    ...
    export class Module extends ModuleFlux {
        ...
        constructor(params) {
            ...
            const parameterName = this.getPersistentData<PersistentData>().parameterName
            const toDecode = this.getPersistentData<PersistentData>().decodeURI
